# Script to apply all requested UI & Loading fixes:
# 1. Immediate loading spinner overlay on "Επιλογή αρχείου" button click
# 2. Tooltip displaying native language name on flag tile hover
# 3. preserveAspectRatio="none" on all 24 EU SVG flags to eliminate white space top/bottom

APP_JS_UPDATED = '''// 24 Official EU Languages Configuration
const LANGUAGES = [
...
const SVG_FLAGS = {
  ...
  es: `<svg viewBox="0 0 750 500" preserveAspectRatio="none"><rect width="750" height="500" fill="#c60b1e"/><rect y="125" width="750" height="250" fill="#ffc400"/><g transform="translate(180, 200) scale(1.5)"><rect x="0" y="0" width="30" height="40" fill="#ad1519" rx="3"/><rect x="30" y="0" width="30" height="40" fill="#fabd00" rx="3"/><circle cx="30" cy="20" r="10" fill="#005293"/></g></svg>`,
  it: `<svg viewBox="0 0 3 2" preserveAspectRatio="none"><rect width="1" height="2" fill="#009246"/><rect x="1" width="1" height="2" fill="#fff"/><rect x="2" width="1" height="2" fill="#ce2b37"/></svg>`,
  pt: `<svg viewBox="0 0 600 400" preserveAspectRatio="none"><rect width="240" height="400" fill="#046A38"/><rect x="240" width="360" height="400" fill="#DA291C"/><circle cx="240" cy="200" r="80" fill="#FFC72C"/><rect x="210" y="160" width="60" height="80" fill="#FFF" rx="10"/><rect x="220" y="170" width="40" height="60" fill="#046A38" rx="5"/></svg>`,
  nl: `<svg viewBox="0 0 3 2" preserveAspectRatio="none"><rect width="3" height="0.67" fill="#AE1C28"/><rect y="0.67" width="3" height="0.67" fill="#fff"/><rect y="1.33" width="3" height="0.67" fill="#21468B"/></svg>`,
  ...
  dk: `<svg viewBox="0 0 37 28" preserveAspectRatio="none"><rect width="37" height="28" fill="#C8102E"/><rect x="12" width="4" height="28" fill="#fff"/><rect y="12" width="37" height="4" fill="#fff"/></svg>`,
  ...
  cz: `<svg viewBox="0 0 3 2" preserveAspectRatio="none"><rect width="3" height="1" fill="#fff"/><rect y="1" width="3" height="1" fill="#d7141a"/><polygon points="0,0 1.5,1 0,2" fill="#11457e"/></svg>`,
  hu: `<svg viewBox="0 0 3 2" preserveAspectRatio="none"><rect width="3" height="0.67" fill="#CD2A3E"/><rect y="0.67" width="3" height="0.67" fill="#fff"/><rect y="1.33" width="3" height="0.67" fill="#436F4D"/></svg>`,
  sk: `<svg viewBox="0 0 6 4" preserveAspectRatio="none"><rect width="6" height="1.33" fill="#fff"/><rect y="1.33" width="6" height="1.33" fill="#0B4EA2"/><rect y="2.66" width="6" height="1.34" fill="#EE1C25"/><g transform="translate(1.2, 0.4) scale(0.75)"><path d="M 0,0 L 2,0 C 2.3,2.5 1.5,3.5 1,3.5 C 0.5,3.5 -0.3,2.5 0,0 Z" fill="#EE1C25" stroke="#fff" stroke-width="0.2"/><path d="M 1,1 L 1,2.8 M 0.4,1.6 L 1.6,1.6 M 0.5,2.2 L 1.5,2.2" stroke="#fff" stroke-width="0.35" stroke-linecap="round"/></g></svg>`,
  bg: `<svg viewBox="0 0 5 3" preserveAspectRatio="none"><rect width="5" height="1" fill="#fff"/><rect y="1" width="5" height="1" fill="#00966E"/><rect y="2" width="5" height="1" fill="#D62612"/></svg>`,
  hr: `<svg viewBox="0 0 6 4" preserveAspectRatio="none"><rect width="6" height="1.33" fill="#FF0000"/><rect y="1.33" width="6" height="1.33" fill="#fff"/><rect y="2.66" width="6" height="1.34" fill="#171796"/><g transform="translate(2.2, 0.7) scale(0.4)"><rect width="4" height="5" fill="#FFF" stroke="#FF0000" stroke-width="0.3"/><rect x="0" y="0" width="0.8" height="1" fill="#FF0000"/><rect x="1.6" y="0" width="0.8" height="1" fill="#FF0000"/><rect x="3.2" y="0" width="0.8" height="1" fill="#FF0000"/><rect x="0.8" y="1" width="0.8" height="1" fill="#FF0000"/><rect x="2.4" y="1" width="0.8" height="1" fill="#FF0000"/><rect x="0" y="2" width="0.8" height="1" fill="#FF0000"/><rect x="1.6" y="2" width="0.8" height="1" fill="#FF0000"/><rect x="3.2" y="2" width="0.8" height="1" fill="#FF0000"/><rect x="0.8" y="3" width="0.8" height="1" fill="#FF0000"/><rect x="2.4" y="3" width="0.8" height="1" fill="#FF0000"/></g></svg>`,
  lt: `<svg viewBox="0 0 5 3" preserveAspectRatio="none"><rect width="5" height="1" fill="#FDB913"/><rect y="1" width="5" height="1" fill="#006A44"/><rect y="2" width="5" height="1" fill="#C1272D"/></svg>`,
  lv: `<svg viewBox="0 0 5 3" preserveAspectRatio="none"><rect width="5" height="1.2" fill="#9E3039"/><rect y="1.2" width="5" height="0.6" fill="#fff"/><rect y="1.8" width="5" height="1.2" fill="#9E3039"/></svg>`,
  ee: `<svg viewBox="0 0 3 2" preserveAspectRatio="none"><rect width="3" height="0.67" fill="#4891D9"/><rect y="0.67" width="3" height="0.67" fill="#000"/><rect y="1.33" width="3" height="0.67" fill="#fff"/></svg>`,
  mt: `<svg viewBox="0 0 6 4" preserveAspectRatio="none"><rect width="3" height="4" fill="#fff"/><rect x="3" width="3" height="4" fill="#CF142B"/><g transform="translate(0.3, 0.3) scale(0.6)"><path d="M 1,0 L 1.3,0.7 L 2,1 L 1.3,1.3 L 1,2 L 0.7,1.3 L 0,1 L 0.7,0.7 Z" fill="#888" stroke="#CF142B" stroke-width="0.15"/></g></svg>`,
  ie: `<svg viewBox="0 0 3 2" preserveAspectRatio="none"><rect width="1" height="2" fill="#169B62"/><rect x="1" width="1" height="2" fill="#fff"/><rect x="2" width="1" height="2" fill="#FF883E"/></svg>`
};
...
function initUI() {
  ...
  // Select File Button - SHOW LOADING OVERLAY IMMEDIATELY!
  document.getElementById('select-file-btn').addEventListener('click', (e) => {
    e.stopPropagation();
    if (window.pywebview && window.pywebview.api) {
      // Show loading spinner immediately so user knows processing starts!
      showLoading(true);
      window.pywebview.api.select_file().then(res => {
        if (!res || res.status === 'cancelled') {
          showLoading(false);
        } else {
          handleFileResult(res);
        }
      }).catch(err => {
        showLoading(false);
        alert(err);
...
function initLanguageGrid() {
  ...
  LANGUAGES.forEach(lang => {
    ...
    tile.dataset.name = lang.name;  // Custom tooltip content
    tile.title = lang.name;         // Native browser fallback tooltip
...
with open('web/app.js', 'w', encoding='utf-8') as f:
    f.write(APP_JS_UPDATED.strip())

print("Updated web/app.js with immediate loading indicator on file select, tooltips on hover, and preserveAspectRatio='none'!")
